...
internal static class CompositionRoot
{
    public static ServiceProvider BuildServiceProvider()
    {
        ...
        services.AddSingleton<IDynamicShawzinScalePlanner, DynamicShawzinScalePlanner>();
        ...
        services.AddSingleton<IDynamicShawzinPreviewRenderer, SyntheticDynamicShawzinPreviewRenderer>();
